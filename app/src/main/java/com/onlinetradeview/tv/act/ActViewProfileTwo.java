...
public class ActViewProfileTwo extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    public ActViewProfileTwo() {
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActViewProfileTwo.this);
